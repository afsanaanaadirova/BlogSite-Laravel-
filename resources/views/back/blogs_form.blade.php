    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Faydalı yazılar</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb justify-content-end">
                        ...
                        <li class="breadcrumb-item active">Faydalı yazılar</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-body">
                    <h4 class="card-title">Faydalı yazılar</h4>
                     @if($errors->any())
                    ...
                    <form class="form-horizontal"  action="{{is_null($blogs) ?  route('store.image') : route('updateBlog',$blogs->id) }}"  method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"value="{{ is_null($blogs) ? '' : $blogs->name }}" name="name" placeholder="Başlıq əlavə edin...">
                        </div>
                        <div class="form-group">
