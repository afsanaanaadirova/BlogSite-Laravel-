        ...
        <div class="footer">
            <div class="col-lg-3 footer-social">
                <div class=" footer-social--info">
                    <h5>STP</h4>
                        <p> 2012-ci ildən etibarən bazarda “STP MMC” adı altında fəaliyyət göstərən şirkətimiz regionun ilk və ən böyük texnoparkıdır. </p>
                </div>
            ...
            <div class="col-lg-3 footer-contact">
                <div class="info">
                    <div> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                        ...
                        <p>Sumqayıt,Azərbaycan<br>H.Z. Tağıyev qəsəbəsi</p>
                    </div>
